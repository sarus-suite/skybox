...
pub(crate) fn set_arg_dump_environment(ssb: &mut SpankSkyBox, value: bool) -> Result<(), Box<dyn Error>> {
...
pub(crate) fn load_plugin_args(ssb: &mut SpankSkyBox, spank: &mut SpankHandle) -> Result<(), Box<dyn Error>> {
